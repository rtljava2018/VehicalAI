...
public class AppConstants {
    ...
    public static final int SIGNATURUREVIEW= 7001;
    public static final int SELFICAMERA= 8001;
    public static final int SELFICAMERAVEDIO= 3001;
    public static final String CONNECTIVITY_ACTION = "11";
    private static String TIME_ZONE = "GMT";
    public static  boolean isGPS = false;
    public static String LANGUAGE_PREF = "Language";

    public static final int APP_PENSIONER=2121;
    public static final int APP_SELFIIMAGE=2122;
    public static final int APP_SELCETFILE=2123;
...
//    public static final String LOGIN = "login_key";
    ...
    public static String getCurrentDateTimeGVTImage(){
